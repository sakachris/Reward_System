...
urlpatterns = [
    ...
    path(
        ...
        PasswordChangeDoneView.as_view(
            template_name='base/registration/password_change_done.html'
        ),
    ...
    path(
        ...
        auth_views.PasswordResetDoneView.as_view(
            template_name='base/registration/password_reset_done.html'
        ),
    ...
    path(
        ...
        auth_views.PasswordResetConfirmView.as_view(
            template_name='base/registration/password_reset_confirm.html'
        ),
    ...
    path(
        ...
        PasswordResetCompleteView.as_view(
            template_name='base/registration/password_reset_complete.html'
        ),
